...
namespace Merchants.Application.Handlers.ComplaintType
{
    ...
    public class DeleteComplaintTypeCommandHandler : IRequestHandler<DeleteCompaintTypeCommand, Response>
    {
        ...
        private readonly IComplaintType _IChannelRepository;
        public DeleteComplaintTypeCommandHandler(IComplaintType merchantRepository, IMapper mapper, ILogger<DeleteComplaintTypeCommandHandler> logger, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<Response> Handle(DeleteCompaintTypeCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                {
                    _logger.LogError($"Type Not found for deletion.");
                ...
                response.ResponseDescription = "Complaint Type deleted Successfully.";
